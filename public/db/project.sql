...
alter table
    department
add
    foreign key (hod) references faculty(fid);
...
insert into
    student (first_name, last_name, sapid, gender, dob, did)
values
    (
        "Nemil",
        "Shah",
...
(
        1,
        "Farmer's Tech",
        "Working on technology to help farmers improve on the efficiency of their farm fields."
    );
...
(
        2,
        "Analysis of Air Pollution in India",
        "Working on trends of air quality of different cities in India."
    );
...
insert into
    library
values
(1, "Deep Learning", 2, "Andrew NG");

insert into
    library
values
(2, "Web Development Basics", 2, "Angela Yu");

insert into
    library
values
(3, "Computer Vision", 2, "Jeff Bezos");

insert into
    library
values
(4, "Electric Vehicles", 2, "Elon Musk");
...
insert into
    library
values
(6, "Adverse Aeroelastic Rotorcraft", 2, "Masarati");

insert into
    library
values
(7, "Encyclopedia of Ocean Engineering", 2, "Cui");
...
insert into
    library
values
(9, "Handbook of Biochips", 2, "Sawan");

insert into
    library
values
(10, "Nanoworkbenches", 2, "Ahner");
...
(
        12,
        "Testing, Modelling and Engineering of YC",
        2,
        "Koenders"
    );
...
(
        15,
        "Vascularization of Tissue Engineering",
        2,
        "Banfi"
    );
...
(
        17,
        "The Stability of Equilibrium Capillary Surfaces",
        2,
        "Slobozhanin"
    );
...
insert into
    library
values
(18, "Organ Tissue Engineering", 2, "Lee");
...
insert into
    library
values
(20, "Rapid Roboting", 2, "Auat Cheein");
...
insert into
    library
values
(23, "Liposome-Based Drug Delivery Systems", 2, "Lu");
...
(
        24,
        "Nanotechnology in Oil and Gas Processing",
        2,
        "Nassar"
    );
...
insert into
    library
values
(26, "Automotive Control", 2, "Isermann");

insert into
    library
values
(27, "High Performance Analog", 2, "Garimella");
...
(
        30,
        "Acoustics for Mechanical Structures",
        2,
        "Herisanu"
    );
...
(
        4,
        "Optimization of Bus Routes in Mumbai",
        "Optimizing bus routes to reduce vehicle traffic."
    );
...
alter table
    library
modify
    column bookid int not null auto_increment unique;

insert into
    library(bname, edition, author)
values
    ("AutoCAD", 3, "Himanshu Pandey");